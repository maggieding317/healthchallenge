...
class _yourFoodPageState extends State<yourFoodPage> {
  ...
  getRate(){
    ...
    setState(() {
      ...
      fatRate = '';
      carbohydrateRate = '';
      if(protein < (dailyprotein - 5)){
        proteinRate = ' ↓';
        count += 1;
      }else if(protein > (dailyprotein + 5) ){
        proteinRate = ' ↑';
        count += 1;
      }
      if(calories < (dailycalories - 100)){
        caloriesRate = ' ↓';
        count += 1;
      }else if(calories > (dailycalories+100)){
        caloriesRate = ' ↑';
        count += 1;
      }
      if(fat < (dailyfat - 10) ){
        fatRate = ' ↓';
        count += 1;
      }else if(fat > (dailyfat + 10) ){
        fatRate = ' ↑';
        count += 1;
      }
      if(carbohydrate < (dailycarbohydrate - 10) ){
        carbohydrateRate = ' ↓';
        count += 1;
      }else if(carbohydrate > (dailycarbohydrate + 10) ){
        carbohydrateRate = ' ↑';
        count += 1;
      }
    });
